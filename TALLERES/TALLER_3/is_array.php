...
$miArray = ["ropa", "balon", "lapiz", "cosa"]; // Reemplaza esto con tu propio array
$miString = "la ropa con balon es un lapiz de cosa"; // Reemplaza esto con tu propio string
$miNumero = 666; // Reemplaza esto con tu propio número
