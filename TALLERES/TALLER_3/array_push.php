...
$misAmigos = ["Eric", "Justin", "Yerell"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Victor", "Tavo"); // Reemplaza las comillas vacías con los nombres de tus amigos
